  ...
  return (
    <footer className="bg-background-light dark:bg-background-dark py-12 md:py-16 text-center border-t border-primary/20 mt-8">
      <div className="max-w-xl mx-auto px-6">
        ...
        <h3 className="serif-text text-2xl md:text-3xl font-bold mb-4 italic text-warm-gray dark:text-white">
          Rest in Eternal Peace
        </h3>

        <p className="text-warm-gray/60 dark:text-gray-400 leading-relaxed mb-8 text-sm md:text-base font-serif italic">
